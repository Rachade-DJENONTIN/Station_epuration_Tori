...
map.getView().fit([387346.888512, 710605.436744, 425820.510760, 732105.402118], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Détermination des sites adéquats pour l\'installation d\'une station d\'épuration dans la commune de Tori-Bossito au Bénin</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (529 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Le présent webmap vise à partager les données produites pour determiner meilleurs sites possible pour l\'implantation d\'une station d\'épuration dans la commune de Tori-Bossito au Bénin.<br />Cela s\'est fait par l\'analyse de données :<br />- topographiques ;<br />- de localisation des zones résidentielles, industrielles et agricoles ;<br />- des réseaux hydrographiques ;<br />- des infrastructures (routes, réseau d\'assainissement) ;<br />- Contraintes environnementales.<br /><br />Veuillez décochez certaines couches superficielles pour mieux voir celles en dessous.';
            }
